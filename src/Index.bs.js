...
var CurrentPath$ReasonReactExamples = require("./CurrentPath/CurrentPath.bs.js");
...
ReactDom.render(React.createElement(CurrentPath$ReasonReactExamples.make, { }), makeContainer("Path"));

ReactDom.render(React.createElement(BlinkingGreeting$ReasonReactExamples.make, {
          children: "Hello!"
        }), makeContainer("Blinking Greeting 3"));
